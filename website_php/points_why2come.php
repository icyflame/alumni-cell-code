<p style="text-align: center; font-size: 20px;">We have 11 good reasons of "Why should you attend the Meet?"</p>

<p style="text-align: jusitfy; font-size: 18px">
...
<br/>
<ol style="margin-left: auto; margin-right: auto; text-align: justify; font-size:15px;font-family:sans-serif;">
	<li>Release yourself from the complexities of the present,  immerse yourself into the past,  re-discover your
		...
		memories to the truth of the present.</br>
	</li></br>
	...
	<li>Days come and go. But the most important thing is to cherish your human connections,  your
		...
		friends and share your experiences after college life. </br>
	</li></br>
	...
	<li>Revisiting your Department is one of the things you will enjoy the most. The classes you bunked,  the
		...
		those buildings,  waiting for you to reopen the chambers.</br>
	</li></br></br>
	...
	<li>Revisiting your Department is one of the things you will enjoy the most. The classes you bunked,  the scolding from  professors,  those warnings of deregistration,  all those memories are preserved in those buildings,  waiting for you to reopen the chambers.</br>
	</li></br></br>
	<li>A time to check in and see,  whether your favorite hang-out spots,  may be parks,  grounds,  canteens or
		restaurants still exist. Or what has replaced them. A chance to tell your family members,  "Oh! I have
		been here."</br>
	...
	<li>A chance to apprise yourself about the building KGPian culture,  what is still preserved and what
		...
		they are playing in helping India advance on the technical front.</br>
	</li></br></br>
	<li>Attending the Meet will provide you a breather from your daily monotonous regime. Taking a trip into
		...
		travel. Its festive season and time for a holiday!</br>
	</li></br></br>

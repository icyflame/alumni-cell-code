<form>
	...
	<h3 style="align:left ">User Registration</h3><hr>
	...
	<div class="row">      
		...
		<div class="col-md-3">Department 1*<br>
			<select style="width:13em" class="required drop-down">
...
<br/><input type="button" value = "submit" onclick="onSubmit()"> 
<br/><br/>